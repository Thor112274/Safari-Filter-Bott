...
premium = environ.get('PREMIUM_LOGS', '-1002134871596')
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "TonyStarkk616") # widout 👉 @
...
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1001663272283').split(','))))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "lokimava11220")
...
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002134871596)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002134871596)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002005906539")) 
